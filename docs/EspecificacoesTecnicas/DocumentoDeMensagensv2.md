...
# MSG001:
O sistema, deve informar ao usuário sempre que não encontrar um registro, um campo obrigatório não preenchido, ação executada com sucesso sempre contextualizado com a funcionalidade em questão...  
...
# MSG004:
O estabelecimento do CNES informado já está cadastrado no sistema para este ente/mantenedor, deseja editá-lo?  
...
# MSG014:
O estabelecimento informado não está vinculado ao seu ente/mantenedor. Verifique o dado informado ou consulte o gestor do estabelecimento.  
...
# MSG018:
Não é permitida a entrada de produtos com a data do documento superior a data atual.  

# MSG019:
Não é permitida a entrada de produtos com a data do documento inferior a 1 ano da data atual.   

# MSG020:
Não é permitida a entrada de produtos com a data de recebimento superior a data atual.  

# MSG021:
Não é permitida a entrada de produtos com a data de recebimento inferior a 1 ano da data atual.  
...
# MSG024:
Produto com data de validade fora dos limites de aceite: inferior ou igual a data atual ou superior a 10 anos.  
