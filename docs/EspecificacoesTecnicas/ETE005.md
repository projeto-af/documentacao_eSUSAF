...
## Descrição
Como usuário, desejo atribuir um perfil de acesso às funcionalidades do sistema para outro usuário. 

## Protótipo 001
![alt text](../imagens/ETE005-Prot1-Atribuir-Perfil-de-Acesso.png)
