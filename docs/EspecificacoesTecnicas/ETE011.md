...
## Descrição
Como usuário, desejo cadastrar ou editar um perfil personalizado de acesso às funcionalidades do sistema, com suas respectivas permissões.

## Protótipo 001
![alt text](../imagens/ETE011-Prot1-Cadastrar-Perfil.png)
...
## Protótipo 002
![alt text](../imagens/ETE011-Prot2-Cadastrar-Perfil.png)
