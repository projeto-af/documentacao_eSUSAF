...
## Descrição 
Como Administrador de uma instância do e-SUS AF, desejo cadastrar um ente/instituição ao sistema, para que o mesmo possa ser utilizado por essa instituição ou ente. 

## Protótipo 001
![alt text](../imagens/ETE014-Prot1-Cadastrar-Entes-Instituicoes.png)
