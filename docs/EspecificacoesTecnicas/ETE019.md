...
## Descrição 
Como usuário, desejo consultar a(s) entrada(s) de produto(s) realizada(s) no estabelecimento de saúde logado

## Protótipo 001
![alt text](../imagens/ETE019-Prot1-Consultar-Entrada.png)
