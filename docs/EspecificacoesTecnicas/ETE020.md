...
## Descrição
Como usuário, desejo cadastrar uma entrada de produto(s) para adicioná-lo(s) ao estoque do estabelecimento de saúde logado

## Protótipo 001
![alt text](../imagens/ETE020-Prot1-Cadastrar-Entrada.png)
![alt text](../imagens/ETE020-Prot1-2-Cadastrar-Entrada.png)
...
## Protótipo 002
![alt text](../imagens/ETE020-Prot2-Cadastrar-Entrada)
![alt text](../imagens/ETE020-Prot2-1-Cadastrar-Entrada)
![alt text](../imagens/ETE020-Prot2-2-Cadastrar-Entrada)
...
## Protótipo 003
![alt text](../imagens/ETE020-Prot3-Cadastrar-Entrada.png)
![alt text](../imagens/ETE020-Prot3-2-Cadastrar-Entrada.png)
![alt text](../imagens/ETE020-Prot3-3-Cadastrar-Entrada.png)
...
2. O(s) produto(s) adicionado(s) à entrada pode(m) ser excluído(s), antes de ser armazenados no sistema. [RGN025](DocumentoDeRegrasv2.md#rgn025);
