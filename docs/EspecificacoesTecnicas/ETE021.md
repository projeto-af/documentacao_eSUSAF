...
Como usuário, desejo editar uma entrada de produto(s) para adicioná-lo(s) ao estoque do estabelecimento de saúde logado

## Protótipo 001
![alt text](../imagens/ETE021-Prot1-Editar-Entrada.png)
![alt text](../imagens/ETE021-Prot1-2-Editar-Entrada.png)
![alt text](../imagens/ETE021-Prot1-3-Editar-Entrada.png)
...
7. Quando o usuário selecionar no campo “Tipo de Movimentação” a opção: “Saldo de Implantação” ou “Ajuste de Estoque”, o preenchimento dos campos “Modalidade de Licitação”, “CNES/CNPJ” (fornecedor), “Razão Social” (fornecedor), “Tipo de Documento”, “Número do Documento” e “Data do Documento” deixa de ser obrigatório. Já se selecionar a opção “Produção Própria”, o preenchimento dos campos “Tipo de Documento”, “Número do Documento” e “Data do Documento” deixam de ser obrigatórios; [RGN024](DocumentoDeRegrasv2.md#rgn024) <!-- Não fazia referência no docx, mas tinha no github -->
...
## Protótipo 002
![alt text](../imagens/ETE021-Prot2-Editar-Entrada.png)
![alt text](../imagens/ETE021-Prot2-2-Editar-Entrada.png)
![alt text](../imagens/ETE021-Prot2-3-Editar-Entrada.png)
...
### Critérios de Aceite 
1. O usuário somente pode acessar a funcionalidade caso tenha permissão. [RGN001] (DocumentoDeRegrasv2.md#rgn001);
2. No campo “Produto” quando o usuário informar: <!-- Não fazia referência no docx, mas tinha no github -->
...
3. O usuário deve selecionar o produto que deseja adicionar na lista produtos ativos no sistema; 
4. O sistema deve recuperar e apresentar os dados da entrada cadastrada previamente, permitindo a edição de todos os campos;
5. O sistema não deve permitir adicionar um produto já relacionado à entrada. [MSG023](DocumentoDeMensagensv2.md#msg023) <!-- Não fazia referência no docx, mas tinha no github -->
6. A sessão produtos os seguintes campos podem ser editados: 
    * N° do lote 
    * Data de validade 
    * Qtd recebida 
    * Valor unitário 
    ...
    * Condições especiais de armazenamento 
    * Endereçamento físico 
7. Somente poderão ser editados as entradas não armazenadas com status “em preenchimento”; 
8. Ao finalizar a edição clicar em “armazenar” ou “salvar parcial”. 
