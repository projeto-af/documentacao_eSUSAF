...
2. O acesso à funcionalidade é dado através do menu lateral no item “Movimentação”, subitem “Entrada”, na tela “Consultar Entrada” quando for acionada a opção “Editar”; <!-- Geralmente estávamos retirando o "Acesso" dos "Critérios de aceite" -->
...
4. A sessão dados de entrada os seguintes campos podem ser editados: 
    * Tipo de movimentação  
    * Modalidade de licitação 
    * N° do empenho 
    * Tipo de documento 
    ...
    * Data do recebimento 
    * Observações 
5. A sessão produtos os seguintes campos podem ser editados: 
    * N° do lote 
    * Data de validade 
    * Qtd recebida 
    * Valor unitário 
...
2. O acesso à funcionalidade é dado através do menu lateral no item “Movimentação”, subitem “Entrada”, na tela “Consultar Entrada” quando for acionada a opção “Editar”;  <!-- Já tem "Acesso" lá em cima, não deveria retirar daqui ao invés de adicionar? -->
