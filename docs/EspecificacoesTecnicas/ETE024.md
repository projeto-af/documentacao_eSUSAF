# ETE024 - Cadastrar Saída Diversa
...
### Elementos de Tela 
* Bread Crumb – “Movimentação / Saída Diversa / Cadastro” 
...
2. O acesso à funcionalidade é dado através do menu lateral no item “Movimentação”, subitem “Saída Diversa”, na tela “Consultar Saída Diversa” quando for acionada a opção “Novo”; 
3. No campo “Tipo de Saída Diversa” o sistema deve apresentar as opções: Ajuste de Estoque, Amostra, Exposição e Análise, Apreensão Sanitária, Empréstimo, Perda, Requisição, Roubo, Transferência, Usuário SUS, Validade Vencida. Exceto os tipos criados para saídas geradas automaticamente pelo sistema: “Saída por Estorno de Entrada”, “Saída por Dispensação” e “Saída por Estorno de Distribuição”; 
4. O campo “Data da Saída Diversa” dever ser preenchido automaticamente com a data atual e desabilitado para edição; 
...
8. Quando o usuário acionar a opção de “Salvar”, o sistema deve verificar se: 
      * Existe uma saída diversa com o mesmo tipo de saída diversa, tipo e número de documento e justificativa de uma saída diversa registrada ou em preenchimento para o estabelecimento. Caso sim, o sistema deve apresentar uma mensagem de alerta ao usuário. [RGN044](DocumentoDeRegrasv2.md#rgn044) [MSG038](DocumentoDeMensagensv2.md#msg038)
      ...
      Atendendo a validações, o sistema grava o registro da saída diversa com estado “Ativo” e a situação “Em preenchimento”, mantêm os campos habilitados para edição, permanece na tela de cadastro da saída diversa e apresenta o campo “Produto(s)”; [MSG031](DocumentoDeMensagensv2.md#msg031) [RGN045](DocumentoDeRegrasv2.md#rgn045) [RGN005](DocumentoDeRegrasv2.md#rgn005)

9. Quando o usuário acionar a opção “Limpar”, o sistema deve apresentar a mensagem de alerta ao usuário. Caso confirme a ação, limpar os campos preenchidos e permanecer na tela de cadastro da saída diversa. Caso a ação não seja confirmada, não limpar os dados informados e permanecer na tela de cadastro da saída diversa; [MSG065](DocumentoDeMensagensv2.md#msg065) 
10. Quando o usuário acionar a opção de “Voltar” ou “Consultar”, o sistema deve apresentar a mensagem de alerta ao usuário. Caso confirme a ação, retornar à tela de consulta as saídas diversas e não salvar as edições realizadas. Caso a ação não seja confirmada, permanece na tela de cadastro da saída diversa; [MSG006](DocumentoDeMensagensv2.md#msg006) 
...
2. O sistema deve apresentar a lista de produtos adicionados à saída diversa por ordem alfabética. A lista será expansiva, permitindo o preenchimento dos campos de detalhamento do produto; [RGN023](DocumentoDeRegrasv2.md#rgn023) 
3. O(s) produto(s) adicionado(s) à saída diversa pode(m) ser excluído(s) desde que não tenha(m) detalhamento(s) vinculado(s) a ele; [RGN035](DocumentoDeRegrasv2.md#rgn035) 
4. O campo “Qtd Estoque Atual” deve ser desabilitado para edição e carregado automaticamente com o saldo do produto em estoque do estabelecimento logado, no momento, independente de lote, validade, fabricante e programa de saúde; [RGN036](DocumentoDeRegrasv2.md#rgn036) 
5. O campo “Quantidade Total” deve ser desabilitado para edição e o sistema deve: 
...
6. O campo “Valor Unitário” deve ser desabilitado para edição, calculado automaticamente através de uma média simples dos valores unitários informados na(s) entrada(s) deste produto, independente de lote, validade, fabricante, programa de saúde, e apresentado em reais (R$) com até 9 dígitos após a virgula; [RGN040](DocumentoDeRegrasv2.md#rgn040) 
...
8. Após adicionar o produto à saída diversa, no detalhamento deste, o sistema deve: 
...
9. Quando o usuário adicionar um detalhamento do produto à saída diversa, o sistema deve verificar se: 
...
10. O sistema deve permitir adicionar mais de um detalhamento ao produto, permitindo a saída do mesmo produto com lotes, validades e programas de saúdes diferentes; 
...
13. O sistema, identificando que uma saída diversa de produto(s) foi registrada, deve debitar a quantidade no saldo deste(s), considerando lote, validade e programa de saúde e atualizar a posição de estoque do estabelecimento que realizou a saída diversa; RGN046 
