...
## Descrição
Como usuário, desejo consultar os dados de posição de estoque dos produtos para emitir um relatório. 

## Protótipo 001
![alt text](../imagens/ETE027-Prot1-Emitir-Relatorio-de-Posicao-de-Estoque.png) -->
