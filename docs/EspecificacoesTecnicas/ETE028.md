...
## Descrição
Como usuário, desejo detalhar o relatório de posição de estoque de produtos no estabelecimento de saúde para visualizar as informações que serão apresentadas no relatório. 

## Protótipo 001
![alt text](../imagens/ETE028-Prot1-Detalhar-Relatorio-de-Posicao-de-Estoque.png)
![alt text](../imagens/ETE028-Prot1-2-Detalhar-Relatorio-de-Posicao-de-Estoque.png)
