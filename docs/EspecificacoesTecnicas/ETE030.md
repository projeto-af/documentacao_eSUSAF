...
## Descrição 
Como usuário, desejo cadastrar um usuário SUS no sistema, uma vez que seja possível a localização deste no portal do CADSUS, através da informação do seu CPF.   

## Protótipo 001
![alt text](../imagens/ETE030-Prot1-Cadastrar-UsuarioSUS.png)
