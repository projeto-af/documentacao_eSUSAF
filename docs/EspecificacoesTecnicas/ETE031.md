...
## Descrição 
Como usuário, desejo editar o cadastro de um usuário SUS através da recuperação de dados do portal do CADSUS para minha instância.

## Protótipo 001
![alt text](../imagens/ETE031-Prot1-Editar-Usuario-SUS.png) 
![alt text](../imagens/ETE031-Prot1-2-Editar-Usuario-SUS.png)
