...
## Descrição
Como usuário, desejo detalhar o cadastro de um usuário SUS através da recuperação de dados do portal do CADSUS para minha instância. 

## Protótipo 001
![alt text](../imagens/ETE032-Prot1-Detalhar-Usuario-SUS.png)
![alt text](../imagens/ETE032-Prot1-2-Detalhar-Usuario-SUS.png)
