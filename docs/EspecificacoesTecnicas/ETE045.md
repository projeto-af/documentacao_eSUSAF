...
Como usuário, desejo consultar a(s) dispensação(ões) de produto(s) realizada(s) no estabelecimento de saúde logado. 

## Protótipo 001 
![alt text](../imagens/ETE045-Prot1-Consultar-Dispensacao.png)
