# ETE048 - Detalhar Relatório de Movimentações

## Descrição
Como usuário, desejo detalhar o relatório de movimentação de produtos no estabelecimento de saúde para visualizar as informações. 

## Protótipo 001 
![alt text](../imagens/ETE048-Prot1-Detalhar-Relatorio-de-Movimentacoes.png)
![alt text](../imagens/ETE048-Prot1-2-Detalhar-Relatorio-de-Movimentacoes.png)
