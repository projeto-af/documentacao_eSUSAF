# ETE049 - Emitir Relatório de Dispensação/Fornecimento

## Descrição
Como usuário, desejo consultar os dados de dispensação/fornecimento dos produtos e emitir em formato de relatório. 

## Protótipo 001 
![alt text](../imagens/ETE049-Prot1-Emitir-Relatorio-de-Dispensacao-Fornecimento.png)
