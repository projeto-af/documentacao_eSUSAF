# ETE050 - Emitir Relatório de Movimentações 

## Descrição 
Como usuário, desejo consultar os dados de movimentações dos produtos para emitir um relatório. 

## Protótipo 001 
![alt text](../imagens/ETE050-Prot1-Emitir-Relatorio-de-Movimentacoes.png)
