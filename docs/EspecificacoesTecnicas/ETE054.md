# ETE054- Estornar dispensação

## Descrição
Como usuário, desejo estornar a(s) dispensação(ões)/fornecimento(s) de produto(s) realizada(s) no estabelecimento de saúde logado. 

## Protótipo 001  
![alt text](../imagens/ETE054-Prot1-Estornar-dispensacao.png)
